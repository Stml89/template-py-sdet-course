...
#
#
# @pytest.mark.parametrize("h_motor,expected", [
#     (240, 4),
#     (808, 14),
#     (0, 0),
#     (60, 1),
#     (1439, 19),
# ])
# def test_motor_time(h_motor, expected):
#     assert motor_time(h_motor) == expected, f"Expected '{expected}' for motor hour {h_motor}"
#
#
